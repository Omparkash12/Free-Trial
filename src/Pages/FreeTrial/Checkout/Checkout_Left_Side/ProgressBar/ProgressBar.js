    ...
    return (
        <section className='progressBar_section'>
            <div className="progress_data">
                <a href='#coffee_section' className="coffee_icon">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="24" cy="24" r="24" fill="#B2BCCA" />
                        <path d="M19.6013 28.5714H26.2008C28.0225 28.5714 29.5005 27.0357 29.5005 25.1429H30.6004C33.027 25.1429 35 23.0929 35 20.5714C35 18.05 33.027 16 30.6004 16H17.1266C16.6694 16 16.3016 16.3821 16.3016 16.8571V25.1429C16.3016 27.0357 17.7796 28.5714 19.6013 28.5714ZM30.6004 18.2857C31.8137 18.2857 32.8002 19.3107 32.8002 20.5714C32.8002 21.8321 31.8137 22.8571 30.6004 22.8571H29.5005V18.2857H30.6004ZM32.2399 32H14.6621C13.026 32 12.5654 29.7143 13.4247 29.7143H33.4739C34.3332 29.7143 33.8795 32 32.2399 32Z" fill="white" />
                    </svg>
                    <h3>Coffee</h3>
                </a>
